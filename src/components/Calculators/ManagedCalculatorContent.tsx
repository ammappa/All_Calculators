        ...
        <div className="container mx-auto px-4 pb-10 md:px-6 2xl:max-w-[1400px]">
            <Card className="border-slate-200/80 shadow-sm">
                ...
                <CardContent className="space-y-8">
                    {item.contentHtml ? (
                        <div
                            className="space-y-4 text-sm leading-7 text-card-foreground [&_blockquote]:border-l-4 [&_blockquote]:border-primary/30 [&_blockquote]:pl-4 [&_blockquote]:italic [&_b]:font-semibold [&_h2]:mt-6 [&_h2]:text-2xl [&_h2]:font-semibold [&_h3]:mt-5 [&_h3]:text-xl [&_h3]:font-semibold [&_li]:mb-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-4 [&_strong]:font-semibold [&_ul]:list-disc [&_ul]:pl-6"
